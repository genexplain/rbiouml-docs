...
profile <- "databases/GTRD/Data/profiles/moderate threshold"

species <- "Human (Homo sapiens)"

biouml.workflow("analyses/Workflows/GTRD/Identify enriched motifs in promoters (GTRD)",
...
biouml.get(paste(output,"/Enriched motifs",sep=""))
