...
biouml.workflow("analyses/Workflows/TRANSPATH/Upstream analysis (TRANSFAC(R) and TRANSPATH(R))",
...
transcription.factors <- biouml.get(paste(output,"/Transcription factors annot",sep=""));
master.regulators     <- biouml.get(paste(output,"/Master regulators annotated",sep=""));
