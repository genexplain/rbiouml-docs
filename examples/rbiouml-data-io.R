...
biouml.import.parameters(ex.folder,"Tabular (*.txt, *.xls, *.tab, etc.)")
...
biouml.import("example_import_table.txt",ex.folder,"Tabular (*.txt, *.xls, *.tab, etc.)",
...
biouml.export.parameters(imp.path,"Tab-separated text (*.txt)");
...
biouml.export(imp.path,"Tab-separated text (*.txt)",
              list(),
